...
import com.android.josias.httpclient.VolleyActivity;
...
public class ExampleRequest{
	...
	public void requestImageGet(VolleyActivity main,  final Context context){
	...
	public void requestImagePost(VolleyActivity main,  final Context context){
